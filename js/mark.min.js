...
*****************************************************/
/**
 * This Universal Module Definition (UMD) wrapper enables mark.js to be used in various environments,
 * including CommonJS, AMD, and as a global variable.
 * @param {Object} e - Global environment (usually `window` or `global`).
 * @param {Function} t - Factory function that initializes and returns the mark.js API.
 */
