 ...
 */
const constants = fetch("../properties.json").then(r=>r.json()).catch(e=>{return {}})
...
async function removeFromCollectionAndDelete(event, type, id = null) {
    ...
    if(type==="manuscript"){
        ...
        const allGlossesOfManuscriptQueryObj = {
            ...
            "__rerum.generatedBy" : httpsIdArray(constants.generator),
        ...
        const allGlosses = allGlossIds.map(glossUri => {
            return fetch(`${constants.tiny}/delete`, {
                method: "DELETE",
